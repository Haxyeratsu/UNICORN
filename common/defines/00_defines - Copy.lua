...
NGame = {
	START_DATE = "76.1.1.12",
	END_DATE = "8245.1.1.12",
	MAP_SCALE_PIXEL_TO_KM = 7.114,					-- Yes, we did the math. Default: 7.114 #was 44.126 actually should be 42.684
	...
	GAME_SPEED_SECONDS = { 1.3, 0.4, 0.2, 0.1, 0.0 }, -- #last one should be 0.060. Must be 5 entries with last one 0 for unbound
	...
	FUEL_RESOURCE = "oil","gas",							-- resource that will give country fuel
	...
	HANDS_OFF_START_TAG = "SE7",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NPolitics = {
	...
	MAX_RANDOM_LEADERS = 0,				-- Maximum amount random leader to have per party. #was 1
...
NMilitary = {
	...
	RETREAT_SPEED_FACTOR = 0.26,                    -- speed bonus when retreating
	...
	NEW_COMMANDER_RANDOM_PERSONALITY_TRAIT_CHANCES = {  -- chances to gain a personality trait for new generals
		0.6, -- 50% for first trait
		0.20  -- 15% for second trait after that
	},
...
NNavy = {
	...
	NAVAL_INVASION_PRIORITY = 2,									-- Default convoy priority for naval invasions #was 1
...
NAI = {
	...
	AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.30,	-- If less than this fraction of units on a front is moving, AI sees it as ready for action	
	...
	DOCKYARDS_PER_NAVAL_DESIRE_EFFECT = -10.0,			-- Effects how much AI wants to build dockyards based on how navally focused they are in general. Recommended range -100.0 to 100.0.
